...
public class GlobalExceptionHandler {
    ...
    public APIResponse<?> exceptionHandle(HttpServletRequest request, Exception e) {
        ...
        return APIResponse.fail(GlobalExceptionResponseEnum.INTERNAL_SERVER_ERROR);
    }

    @ExceptionHandler(value = HttpClientErrorException.Unauthorized.class)
    public APIResponse<?> unauthorizedException() {
        log.error("[GlobalExceptionHandler.unauthorizedException]");
        return APIResponse.fail(GlobalExceptionResponseEnum.BIZON_UNAUTHORIZED_EXCEPTION);
    }

    @ExceptionHandler(value = HttpClientErrorException.Forbidden.class)
    public APIResponse<?> forbiddenException() {
        log.error("[GlobalExceptionHandler.forbiddenException]");
        return APIResponse.fail(GlobalExceptionResponseEnum.BIZON_FORBIDDEN_EXCEPTION);
    }
    ...
    public APIResponse<?> httpServerErrorException(HttpServletRequest request, HttpServerErrorException e) {
        ...
        errorLogging(e, request);
        return APIResponse.fail(GlobalExceptionResponseEnum.SERVICE_UNAVAILABLE);
    }
    ...
    public APIResponse<?> noResourceFoundException(HttpServletRequest request, NoResourceFoundException e) {
        ...
        errorLogging(e, request);
        return APIResponse.fail(GlobalExceptionResponseEnum.BAD_REQUEST);
    }
    ...
    public APIResponse<?> noHandlerFoundException(HttpServletRequest request, NoHandlerFoundException e) {
        ...
        errorLogging(e, request);
        return APIResponse.fail(GlobalExceptionResponseEnum.NOT_FOUND);
    }


    @ExceptionHandler(value = MissingServletRequestParameterException.class)
    public APIResponse<?> missingServletRequestParameterException(HttpServletRequest request, MissingServletRequestParameterException e) {
        ...
        return APIResponse.fail(GlobalExceptionResponseEnum.PLEASE_CHECK_REQUEST_VALUES, message);
    }


    @ExceptionHandler(value = {HandlerMethodValidationException.class})
    public APIResponse<?> handlerMethodValidationException(HttpServletRequest request, HandlerMethodValidationException e) {
        ...
        return APIResponse.fail(GlobalExceptionResponseEnum.PLEASE_CHECK_REQUEST_VALUES, errorMessage);
    }
    ...
    public APIResponse<?> bindException(HttpServletRequest request, BindException e) {
        ...
        return APIResponse.fail(GlobalExceptionResponseEnum.PLEASE_CHECK_REQUEST_VALUES, detailedErrorMessage);
    }
    ...
    public APIResponse<?> businessException(HttpServletRequest request, BusinessException e) {
        ...
        if (e.getException() != null) {
            if (e.getArgs() != null && e.getArgs().length > 0) {
                log.error("[GlobalExceptionHandler.businessException] {} . {}", e.getException().getMessage(), e.getArgs());
    ...
    @ExceptionHandler(value = MissingRequirementDataException.class)
    public APIResponse<?> missingRequirementValueException(HttpServletRequest request, MissingRequirementDataException e) {
        log.error("[GlobalExceptionHandler.missingRequirementValueException] {}", request.getRequestURI());
        errorLogging(e.getException(), request);
        if (e.getArgs() != null && e.getArgs().length > 0) {
            return APIResponse.fail(e.getExceptionResponseContract(), e.getMissingRequirementDataDetails(), e.getArgs());
        } else {
            return APIResponse.fail(e.getExceptionResponseContract(), e.getMissingRequirementDataDetails());
        }
    }
